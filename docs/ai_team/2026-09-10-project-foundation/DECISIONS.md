...
11. SPEC-000 принят после независимых review/QA и реального успешного CI/deploy, rollback и повторной доставки. Runtime SHA 62349369; документационные уточнения после этого не требуют повторной сборки неизменённого кода.
